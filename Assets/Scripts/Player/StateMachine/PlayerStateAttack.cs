...
public class PlayerStateAttack : PlayerState
{
    ...
    public PlayerStateAttack(PlayerStateMachine playerStateMachine, InputReader inputReader, GroundDetector groundDetector, PlayerAnimator playerAnimator, Rigidbody2D rigidbody2D, Flipper flipper) : base(playerStateMachine, inputReader, groundDetector, playerAnimator, rigidbody2D, flipper)
    {
    }
